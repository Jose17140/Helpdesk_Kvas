...
INSERT INTO GruposDetalles(Nombre,Descripcion,IdGrupo,Icono,Orden,IdPadre,UrlDetalle,FechaRegistro)VALUES
('Servicio Hardware','Servicio Tecnico Hardware',18,'fa fa-archive',1,32,'/',GETDATE()),
('Servicio Software','Servicio Tecnico Software',18,'fa fa-archive',2,32,'/',GETDATE()),
('Venta Hardware','Venta Tecnico Hardware',18,'fa fa-archive',1,33,'/',GETDATE()),
('Venta Software','Venta Tecnico Software',18,'fa fa-archive',2,33,'/',GETDATE());
...
--EQUIPOS
INSERT INTO GruposDetalles(Nombre,Descripcion,IdGrupo,Icono,Orden,IdPadre,UrlDetalle,FechaRegistro)VALUES
('Computadora','Computadora de Escridorio',7,'fa fa-user',1,0,'*',GETDATE()),
('Impresora','Impresoras',7,'fa fa-archive',2,0,'*',GETDATE()),
('Laptop','Laptops',7,'fa fa-archive',3,0,'*',GETDATE()),
('Router','Routes',7,'fa fa-archive',4,0,'*',GETDATE()),
('Servidor','Servidores',7,'fa fa-archive',5,0,'*',GETDATE()),
('Disco Duro','Recuperacion de Datos',7,'fa fa-archive',5,0,'*',GETDATE());
